...
def FITNet_res34(pretrained=False, **kwargs):
    """
...
def FITNet_res18(pretrained=False, **kwargs):
    """
    Constructs a FIT-Net model.
    """
...
if __name__ == '__main__':
    ...
    img = torch.randn(64, 1, 224, 224).cuda()
    model = FITNet_res18(num_classes=2)
    ...
    macs, params = profile(model, inputs=(torch.randn((2, 1, 224, 224)).cuda(),))
