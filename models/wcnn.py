...
from models.lifting import WaveletHaar2D, LiftingScheme2D, Wavelet2D

"""
https://github.com/mxbastidasr/DAWN_WACV2020/blob/5fc336575a/models/wcnn.py
"""
...
class WCNN(nn.Module):
    ...
    def __init__(self, num_classes, big_input=True, wavelet='haar', levels=4):
        ...
        in_level_1 = 4 * 1
        in_level_2 = in_level_1 + 4 * 1 + 64 * 2
        in_level_3 = in_level_2 + 4 * 1 + 128 * 2
        in_level_4 = in_level_3 + 4 * 1 + 256 * 2
        print("Levels (DEBUG): ")
        print("-", in_level_1)
        print("-", in_level_2)
        print("-", in_level_3)
...
if __name__ == '__main__':
    ...
    net = WCNN(NUM_CLASS, big_input=big_input, wavelet=wavelet, levels=levels).cuda()
    print(net)
