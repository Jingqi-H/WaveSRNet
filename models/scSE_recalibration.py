...
refer: https://github.com/ai-med/squeeze_and_excitation/blob/master/squeeze_and_excitation/squeeze_and_excitation.py
"""
...
if __name__ == '__main__':
    ...
    x = torch.randn([16,64,1,1])
    csSE = ChannelSpatialSELayer(64)
    sSE = SpatialSELayer(64)
    cSE = ChannelSELayer(64)
    print(csSE(x).shape)
    print(sSE(x).shape)
    print(cSE(x).shape)