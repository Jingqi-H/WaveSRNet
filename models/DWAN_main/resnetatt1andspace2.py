...
def resnet18_dual_wave(num_classes=2, levels=4):
    res18 = ResNetCIFAR(layers=[2,2,2,2], num_classes=num_classes, levels=levels)
    return res18

if __name__ == '__main__':
    import os
    os.environ["CUDA_VISIBLE_DEVICES"] = '3'
    net = resnet18_dual_wave(num_classes=2, levels=4)
